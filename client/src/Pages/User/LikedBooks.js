...
import { Avatar, IconButton, Popover, Card, Tabs, Tab, Modal } from "@mui/material";
...
const columns = [
    ...
    { field: "publicationDate", headerName: "Published Date", flex: 2, valueGetter: (params) => (fDate(params.row.publicationDate, "yyyy")), },
    {
      field: "actions",
      headerName: "Actions",
      flex: 1,
